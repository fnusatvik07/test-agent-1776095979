...
class AgentChat {
    ...
    async checkBackendStatus() {
        try {
            ...
            const backendUrl = this.backendUrl || (this.backendUrlInput ? this.backendUrlInput.value : null) || 'http://localhost:8003';
    ...
    async tryAlternativePorts() {
        ...
        const portsToTry = [
            ...
            8003,    // Fallback to generated port
    ...
    getBackendUrl() {
        return this.backendUrl || (this.backendUrlInput ? this.backendUrlInput.value : null) || 'http://localhost:8003';
    }
